    ...
    public function run($parameters = [])
    {
        ...
        DB::table('attributes')->insert([
            ...
            [
                ...
                'code'            => 'lead_organisation',
                'name'            => trans('installer::app.seeders.attributes.leads.organisation', [], $defaultLocale),
                'type'            => 'select',
                'entity_type'     => 'leads',
            ...
            [
                'code'            => 'description',
                'name'            => trans('installer::app.seeders.attributes.persons.description', [], $defaultLocale),
                'type'            => 'textarea',
                'entity_type'     => 'persons',
                'lookup_type'     => null,
                'validation'      => null,
            ...
            [
                'code'            => 'socials',
                'name'            => trans('installer::app.seeders.attributes.persons.socials', [], $defaultLocale),
                'type'            => 'socials',
                'entity_type'     => 'persons',
                'lookup_type'     => null,
                'validation'      => null,
